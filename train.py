...
def train(train_img_path, train_gt_path, pths_path, batch_size, lr, num_workers,
    ...
    trainset = TextDataset(train_img_path, train_gt_path)
    ...
    model = TextDetector(True, 'weights/vgg16_bn-6c64b313.pth')
    data_parallel = False
    ...
    for epoch in range(epoch_iter):
        ...
        for i, (img, gt_score, gt_geo, ignored_map) in enumerate(train_loader):
            ...
            print(
                'Epoch is [{}/{}], mini-batch is [{}/{}], time consumption is {:.8f}, batch_loss is {:.8f}'.format( \
                    epoch + 1, epoch_iter, i + 1, int(file_num / batch_size),
        ...
        if (epoch + 1) % interval == 0:
            ...
            torch.save(state_dict, os.path.join(pths_path,
